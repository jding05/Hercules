...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/17 16:03:24 by sding             #+#    #+#             */
/*   Updated: 2018/06/17 16:03:26 by sding            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void) {
	...
	write(1, &magic, 8);
	del_unrolled(list);
	/* don't need to free tmp, because tmp and list are pointing to the same location */
	free(list);
	return(0);
}
